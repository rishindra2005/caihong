...
export async function POST(request: NextRequest) {
  console.log("XeLaTeX compiler endpoint called");
  ...
  try {
    ...
    // Set the compiler explicitly to xelatex
    const requestWithCompiler = {
      ...body,
      compiler: 'xelatex'
    };
    console.log("Forwarding to main compile endpoint with compiler set to xelatex");
    ...
    console.error("Error in xelatex route:", error);
    return NextResponse.json({
      error: "XeLaTeX compilation route error",
