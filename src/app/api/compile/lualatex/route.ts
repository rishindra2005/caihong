...
export async function POST(request: NextRequest) {
  console.log("LuaLaTeX compiler endpoint called");
  ...
  try {
    ...
    // Set the compiler explicitly to lualatex
    const requestWithCompiler = {
      ...body,
      compiler: 'lualatex'
    };
    console.log("Forwarding to main compile endpoint with compiler set to lualatex");
    ...
    console.error("Error in lualatex route:", error);
    return NextResponse.json({
      error: "LuaLaTeX compilation route error",
